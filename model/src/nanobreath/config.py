...
# Local backbone location. The NanoPitch backbone (model.py + best.pth) ships
# under model/weights/nanopitch/, so the project runs standalone with no env vars.
# Override with $NANOPITCH_CHECKPOINT / $NANOPITCH_SRC_DIR if needed.
_LOCAL_BACKBONE_DIR = _REPO_ROOT / "weights" / "nanopitch"
